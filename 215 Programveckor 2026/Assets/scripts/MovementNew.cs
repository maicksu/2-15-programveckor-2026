    ...
    void Update()
    {
        ...
        if (state == "moving") 
        {
            ...
            print("Player turn: " +playerturn);
                ...
                if (TilePosition[playerposition[playerturn]].y == 0 && TilePosition[playerposition[playerturn]].y != 14 && Input.GetKeyDown(KeyCode.D))
                {
                Debug.Log("fucking hell");

                playerposition[playerturn] += movement;
                playerposition[playerturn] += TilePosition.Count;
                playerposition[playerturn] %= TilePosition.Count;
                avplayers[playerturn].transform.position = (Vector2)TilePosition[playerposition[playerturn]];
                boardSpace.OnLand();

                }
                if ((TilePosition[playerposition[playerturn]].y == -14 && TilePosition[playerposition[playerturn]].x != 14 && Input.GetKeyDown(KeyCode.D)))
                {
                playerposition[playerturn] -= movement;
                playerposition[playerturn] += TilePosition.Count;
                playerposition[playerturn] %= TilePosition.Count;
                ...
                if (TilePosition[playerposition[playerturn]].x == 14 && TilePosition[playerposition[playerturn]].y != -14 && Input.GetKeyDown(KeyCode.S))
                {
                playerposition[playerturn] += movement;
                playerposition[playerturn] += TilePosition.Count;
                playerposition[playerturn] %= TilePosition.Count;
                ...
                if (TilePosition[playerposition[playerturn]].x == 0 && TilePosition[playerposition[playerturn]].y != -14 && Input.GetKeyDown(KeyCode.S))
                {
                playerposition[playerturn] -= movement;
                playerposition[playerturn] += TilePosition.Count;
                playerposition[playerturn] %= TilePosition.Count;
                ...
                if (TilePosition[playerposition[playerturn]].y == -14 && TilePosition[playerposition[playerturn]].x != 0 && Input.GetKeyDown(KeyCode.A))
                {
                playerposition[playerturn] += movement;
                playerposition[playerturn] += TilePosition.Count;
                playerposition[playerturn] %= TilePosition.Count;
                ...
                if (TilePosition[playerposition[playerturn]].y == 0 && TilePosition[playerposition[playerturn]].x != 0 && Input.GetKeyDown(KeyCode.A))
                {
                playerposition[playerturn] -= movement;
                playerposition[playerturn] += TilePosition.Count;
                playerposition[playerturn] %= TilePosition.Count;
                ...
                if (TilePosition[playerposition[playerturn]].x == 0 && TilePosition[playerposition[playerturn]].y != 0 && Input.GetKeyDown(KeyCode.W))
                {
                playerposition[playerturn] += movement;
                playerposition[playerturn] += TilePosition.Count;
                playerposition[playerturn] %= TilePosition.Count;
                ...
                if (TilePosition[playerposition[playerturn]].x == 14 && TilePosition[playerposition[playerturn]].y != 0 && Input.GetKeyDown(KeyCode.W))
                {
                playerposition[playerturn] -= movement;
                playerposition[playerturn] += TilePosition.Count;
                playerposition[playerturn] %= TilePosition.Count;
